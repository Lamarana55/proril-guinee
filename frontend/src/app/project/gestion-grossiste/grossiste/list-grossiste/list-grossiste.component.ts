...
@Component({
  selector: 'app-list-grossiste',
  templateUrl: './list-grossiste.component.html',
  styleUrls: ['./list-grossiste.component.css']
})
export class ListGrossisteComponent implements OnInit {
  ...
  displayedColumns = [ 'nom_prenom', 'email', 'telephone', 'region', 'prefecture', 'commune', 'option'];
...
/* ======================================== */
 ...
 async getElement(params: RequestCasParam= { page: this.currentPage, size: this.pageSize, role : "ROLE_GROSSISTE" }){
