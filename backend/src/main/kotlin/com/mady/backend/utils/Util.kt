...
//        const val CAN_VIEW_DASHBORD = "CAN_VIEW_DASHBOARD"
        ...
        const val CAN_VIEW_CATEGORIE_ARTICLE_MENU = "CAN_VIEW_CATEGORIE_ARTICLE_MENU"
        const val CAN_VIEW_CATEGORIE_ARTICLE_LIST = "CAN_VIEW_CATEGORIE_ARTICLE_LIST"
        const val CAN_VIEW_CATEGORIE_ARTICLE_INFO = "CAN_VIEW_CATEGORIE_ARTICLE_INFO"
        const val CAN_ADD_CATEGORIE_ARTICLE = "CAN_ADD_CATEGORIE_ARTICLE"
        const val CAN_UPDATE_CATEGORIE_ARTICLE = "CAN_UPDATE_CATEGORIE_ARTICLE"
        const val CAN_DELETE_CATEGORIE_ARTICLE = "CAN_DELETE_CATEGORIE_ARTICLE"
